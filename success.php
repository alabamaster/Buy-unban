				...
				<div class="card">
					<div class="card-body" style="font-size: 13px;">
						<div class="alert alert-success" role="alert">
							<h6>В скором времени бан будет снят, ожидайте!</h6>
							Ваш IP: <?=$_REQUEST['us_ip'];?><br>
							Ваш Steam ID: <?=$_REQUEST['us_steamid'];?><br>
							Ваш ник: <?=$_REQUEST['us_nick'];?><br>
							ID оплаты: <?=$_REQUEST['MERCHANT_ORDER_ID'];?>
						</div>
					</div>
				</div>
			</div>
